    ...
    <div>
      ...
      {isExpanded && (
        <div className="expanded-container">
          ...
          <div style={{ flex: 1 }}>
            <p style={{ color: '#212121', fontSize: 14 }}>Tax ID Number</p>
            <div className="p-field">
              <InputText
                style={{ width: 290 }}
                id="taxIDNumber"
          ...
          <div style={{ flex: 1 }}>
            ...
            <div className="p-field">
              <Dropdown
                ...
                id="msicCode"
                value={msicCode}
                options={stateOptions} // Update with correct options
          ...
          <div style={{ flex: 1 }}>
            ...
            <div className="p-field">
              <InputText
                ...
                onChange={(e) => setSupplierDigiSign(e.target.value)}
                className={errors.supplierDigiSign ? 'p-invalid' : ''}
              />
          ...
          <div style={{ flex: 1 }}>
            ...
            <div className="p-field">
              <FileUpload
                id="uploadDigitalSignature"
                customUpload
                uploadHandler={handleSupplierSignFileChange}
                className={supplierSignatureError && 'p-invalid'}
                auto
              />
              {supplierSignatureError && (
                <small className="p-error">{supplierSignatureError}</small>
              )}
            </div>
          </div>
        </div>
