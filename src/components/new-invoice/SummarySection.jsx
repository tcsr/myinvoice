...
const SummarySection = ({ summary }) => {
  return (
    <div className="summary-section equal-width border-none">
      ...
      <div className="summary-item">
        ...
        <span className="summary-value discount-amount">-${summary.totalDiscount.toFixed(2)}</span>
      </div>
      <div className="summary-item">
        <span className="summary-label">Net Total</span>
        <span className="summary-value net-total-value">${summary.netTotal.toFixed(2)}</span>
      </div>
    </div>
  );
};
